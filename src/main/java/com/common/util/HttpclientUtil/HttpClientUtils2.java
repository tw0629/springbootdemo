package com.common.util.HttpclientUtil;

import com.common.Exception.ServiceException; // 自定义的一个异常类, 简单实现
...
// 参考 https://blog.csdn.net/xinxiran/article/details/78893986
