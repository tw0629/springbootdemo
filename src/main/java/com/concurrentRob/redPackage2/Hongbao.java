package com.concurrentRob.redPackage2;
...
public class Hongbao {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 10; i++) {
            List<BigDecimal> moneys = math(BigDecimal.valueOf(1), 12);
            if (moneys != null) {
    ...
    /** * 计算每人获得红包金额;最小每人0.01元 * @param mmm 红包总额 * @param number 人数 * @return */
